										...
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													...
													customer_addCustomerUi.action" target=main>－ 新增客户</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath}/
													customer_findCustomerPage.action"
										...
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath}/
													linkman_addUi.action" target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath}/
													linkman_findByPage.action" target=main>－联系人列表</A></TD>
												</TR>
